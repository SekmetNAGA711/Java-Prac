...
public class Loops {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 17; i++) {//a for loop servers as a more compat version of a while loop, all in one loop. In a for loop the parentheses holds the variable,
        ...
        while(i < 15) {//The difference btw a while loop and an if statement is that if a condition is met the body of program is executed and ends,
