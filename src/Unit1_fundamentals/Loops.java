...
public class Loops {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 28; i++) {//a for loop servers as a more compat version of a while loop, all in one loop. In a for loop the parentheses holds the variable,
        ...
        while(i < 17) {//The difference btw a while loop and an if statement is that if a condition is met the body of program is executed and ends,
...
//       } while (i < 6);
        ...
        ThreadLocalRandom.current().nextInt(1, 17); // This method is used to generate random numbers, like throwing dice giving range from 1 to 6, the first number is inclusive while the second number is exclusive
