...
public class Loops {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 15; i++) {//a for loop servers as a more compat version of a while loop, all in one loop. In a for loop the parentheses holds the variable,
